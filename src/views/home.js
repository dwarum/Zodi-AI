...
const Home = (props) => {
  ...
  // const [fadeText1, setFadeText1] = useState(false);
  // const [fadeText2, setFadeText2] = useState(false);

  // useEffect(() => {
  //   // Start the fade-out effect for Text 1 after 1 second
  ...
  const textToType = "Unlock Your Cosmic Blueprint with Our Vedic Astrology AI"; // Text to type out
  ...
  useEffect(() => {
    ...
    const typingTimer = setInterval(() => {
      setTypedText((prevTypedText) => prevTypedText + textToType.charAt(index));
      index++;
  ...
  return (
    <div style={{backgroundImage:`url("/source.jpg")`,
    backgroundRepeat:"no-repeat",
    backgroundSize: "contain"
    }} className="home-container">
      <Helmet>
        <title>Ask Zodi</title>
        <meta property="og:title" content="Ask Zodi" />
      </Helmet>
      <header data-thq="thq-navbar" className="home-navbar">
      <div className="home-heading">
        <h1 style={{fontFamily:"serif",color:"black"}} className={`fade-in ${fadeInText2 ? 'home-header' : 'hidden'}`}>
          ASK ZODI
        </h1>
        <div style={{fontFamily:"serif",fontStyle:"italic",color:"black",fontSize:"20px",fontWeight:"100"}} className={`fade-in ${fadeInText2 ? '' : 'hidden'}`}>
          Unlock Your Cosmic Blueprint with Our Vedic Astrology AI
        </div>
      </div>
        ...
        >
          ...
          >
            ...
            <button className="home-button button-clean button">Features</button>
            <button className="home-button button-clean button">Team</button> */}
          </nav>
        </div>
      ...
      <div style={{fontWeight:"100"}} className={`fade-out ${fadeOutText1 ? 'hidden': ''}`}>
        ...
        <span style={{fontFamily:"sans-serif",fontStyle:"italic"}} className={`fade-in ${fadeText2 ? '' : 'hidden'}`}>{typedText}</span> */}
        {/* <span>{typedText}</span> */}
        {/* <p className={`fade-in ${fadeText2 ? 'home-caption' : 'hidden'}`}>
            Fools obey the planets while wise men control them </p> */}
        {/* <h1 className={`fade-in ${fadeText2 ? 'home-header' : 'hidden'}`}>ZODI</h1>
        <p className={`fade-out ${fadeText1 ? 'hidden home-caption' : 'home-caption'}`}>
            Fools obey the planets while wise men control them
          </p> */}
        </div>
      ...
      <section className="home-description">
        <img
          ...
          //src="/pixlr-image-generator-1.png"
